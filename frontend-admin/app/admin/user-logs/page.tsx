...
export default function UserAuditLogsPage() {
    ...
    if (selectedCategory === 'ALL') {
        return (
            <div className="space-y-4 sm:space-y-6">
                {/* Header */}
                <div>
                    <h1 className="text-xl sm:text-2xl font-semibold text-black">User Activity Logs</h1>
    ...
    return (
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                {isLoading ? (
                    <div className="p-12 text-center text-gray-500">Loading user audit logs...</div>
