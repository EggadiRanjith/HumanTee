                ...
                <div className="max-w-md w-full bg-white rounded-lg border border-gray-200 p-6 shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-gray-900">
                                {isNetworkError ? 'Connection Failed' : isServerError ? 'Server Error' : 'Failed to Load Dashboard'}
                            </h2>
                            <p className="text-sm text-gray-600">
                                {isNetworkError ? 'Check your internet connection' : isServerError ? 'Backend is unavailable' : 'Unable to fetch data'}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => refetch()}
                            disabled={isFetching}
                            className="flex-1 px-4 py-2 bg-black text-white text-sm font-medium rounded-lg hover:bg-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
                        >
                            {isFetching ? (
                                <>
