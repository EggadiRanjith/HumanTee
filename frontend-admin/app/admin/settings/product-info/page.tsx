...
export default function ProductInfoSettings() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-3 md:p-4 lg:p-6 xl:p-8 pb-32">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-4 md:mb-6 lg:mb-8 flex items-center justify-between">
                    <div>
                        <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-gray-900">Product Information</h1>
