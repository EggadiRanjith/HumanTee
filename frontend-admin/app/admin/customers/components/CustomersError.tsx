/**
 * Customers Error Component - ENHANCED
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold text-gray-900">
                            {isNetworkError ? 'Connection Failed' : isServerError ? 'Server Error' : 'Failed to Load Customers'}
                        </h2>
                        <p className="text-sm text-gray-600">
                            {isNetworkError ? 'Check your internet connection' : isServerError ? 'Backend is unavailable' : 'Unable to fetch customers'}
                        </p>
                    </div>
                </div>
