...
export default function TicketDetailPage() {
    ...
    return (
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 md:gap-4 bg-white p-2.5 md:p-3 lg:p-4 rounded-xl border border-gray-200 shadow-sm">
                <div className="flex items-center gap-2 md:gap-4">
                    <Link href="/admin/tickets">
                        <button className="p-1.5 md:p-2 hover:bg-gray-100 rounded-lg transition-colors">
                            <FiArrowLeft className="w-4 h-4 md:w-5 md:h-5 text-gray-600" />
                        </button>
                    </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="lg:col-span-2 flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden" style={{ height: 'calc(100vh - 250px)', maxHeight: '700px', minHeight: '500px' }}>
                    {/* Messages Area */}
                    <div className="flex-1 overflow-y-auto p-3 md:p-4 lg:p-6 space-y-4 md:space-y-6 bg-gray-50/30">
                    ...
                    {/* Reply Input - Compact Mobile */}
                    <div className="p-2.5 md:p-4 border-t border-gray-100 bg-white">
                        {(ticket.status === 'closed' || ticket.status === 'resolved') ? (
                            <div className="text-center py-8 px-4">
                                ...
                                <p className="text-xs text-gray-400">
                                    Reopen the ticket to send messages
                                </p>
                            </div>
                        ) : (
                            <>
