/**
 * Discounts Skeleton - PROFESSIONAL QUALITY
 * Matches exact layout with shimmer animation
 * Shows discount cards grid
 */
    ...
    return (
        <div className="space-y-3 md:space-y-4">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="h-9 md:h-10 w-36 md:w-44 bg-black opacity-10 rounded-lg shimmer"></div>
            </div>
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex-1 space-y-2">
                                <div className="h-5 bg-gray-300 rounded shimmer w-3/4"></div>
                        ...
                        {/* Discount value */}
                        <div className="h-8 bg-purple-200 opacity-30 rounded shimmer mb-3 w-28"></div>
                        ...
                        <div className="flex gap-2 mt-4">
                            <div className="flex-1 h-8 bg-gray-200 rounded shimmer"></div>
