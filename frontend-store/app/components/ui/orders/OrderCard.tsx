            ...
            <div className="flex-1 flex flex-col justify-between">
                <div>
                    <div className="flex items-center gap-2 sm:gap-3 mb-1 flex-wrap">
                        <h3 className="text-white text-[14px] sm:text-[16px] font-light tracking-wide truncate max-w-[200px] sm:max-w-none">
                            {order.orderNumber}
                        </h3>

                        <span className={`flex items-center gap-1.5 px-2 py-1 ${status.bg} rounded-md flex-shrink-0`}>
                    ...
                    <p className="text-white/55 text-[12px] mb-1 leading-relaxed">
                    ...
                    {order.trackingNumber && (
                        <p className="text-white/55 text-[12px] truncate max-w-full">Tracking: {order.trackingNumber}</p>
                    )}
                </div>

                {/* Amount + CTA */}
                <div className="flex items-center gap-3 sm:gap-4 mt-3 sm:mt-4 flex-wrap">
                    <p className="text-white text-[16px] sm:text-[18px] font-light">₹{Number(order.totalAmount).toFixed(2)}</p>
