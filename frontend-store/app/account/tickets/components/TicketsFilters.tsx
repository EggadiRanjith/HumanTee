 ...
 * Filter controls for tickets page with status, category, sort, and search
 */
...
const STATUS_OPTIONS = [
    ...
    { value: 'waiting_on_customer', label: 'Action Needed' },
...
export function TicketsFilters({ filters, onFilterChange, onClearFilters, hasActiveFilters }: TicketsFiltersProps) {
    return (
